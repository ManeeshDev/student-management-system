	...
	<div class="container">
		<?php 
			if (isset($_GET['msg']) and isset($_GET['Ino']) ) {
				if ($_GET['msg'] == "success") {
					$ino = $_GET['Ino'];
					echo '<center><div class="bg-success text-light">The Student ( '.$ino.' ) Successfully Updated..</div></center>';
				}
			}
					...
					<table class='table table-light table-hover'>
				  	...
				  	while ($row=mysqli_fetch_array($result)) 
				  	{
					    echo "<tr class='table-active'>
			    		      ...
			    		      <td>".$row['Gender']."</td>
			    		      <td>".$row['DOB']."</td>
			    		      <td><a class='abtn3' href='updateStudent.php?Ino=".$row['IndexNo']."'>&nbsp;Update&nbsp;</a></td>
			    		    </tr> ";
				  	};
				echo "</tbody>
					</table> " ;
...
<?php require_once ('include/footer.php') ?>
		    ...
		    <!-- <td><a href="UpdateStudent.php?ino=<?php //echo $row['IndexNo'];?>">Update</a></td>
		<?php //echo"</tr>"; -->